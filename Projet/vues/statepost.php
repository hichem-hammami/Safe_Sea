            ...
            <div class ="container" align="center">
                    ...
                    <div class="c">
                        <div class="charts-grids widget"id="pdf">
                            ...
                            <h4 class="btn btn-xs btn-primary btn-block">Articles statistics (Over 20 $/Under 20 $)</h4>
              <br>
                    ...
                    <?php
                    $query= $pdo ->prepare("select count(prix)as nombre,prix from article GROUP by prix");
